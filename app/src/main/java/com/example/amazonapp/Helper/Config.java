...
public class Config {
  ...
  public static final String FORGETPASSWORD="http://18.218.124.225:3000/api/customeruser/forgetPasswordCustomer";
  public static final String GETPROFILE="http://18.216.15.198:3000/api/companyuser/getuserdetailsbyid?userid=1";
